...
export async function GET(request: Request) {
  ...
  return new ImageResponse(
    <div style={{ display: "flex", position: "relative", width: "100%", height: "100%", padding: "67px 78px", flexDirection: "column", justifyContent: "space-between", overflow: "hidden", background: "#122b22", color: "#fff", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, fontSize: 23, fontWeight: 700, letterSpacing: 3 }}>
        <div style={{ display: "flex", width: 46, height: 46, alignItems: "center", justifyContent: "center", background: "#d2ddbf", color: "#122b22", fontSize: 32, fontWeight: 800 }}>G</div>
        GREENSPROUT
      </div>
