...
export default function GuidesPage() {
  return <><SiteHeader/><main>
    ...
    <section className="p5-guides-call"><Image src={photo.siteAssessment} alt="" fill sizes="100vw"/><div className="p6-guides-call-shade"/><div className="page-shell"><p className="eyebrow light">Need advice for your land?</p><h2>Every site has its own questions.</h2><p>Share a few details and we will help you decide whether you need a consultation, a site assessment or a project quotation.</p><ButtonLink href="/quote" label="Tell us about your site" variant="light"/></div></section>
  </main><SiteFooter/></>;
}
